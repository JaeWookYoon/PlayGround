...
제1조(목적)
이 약관은 누리보듬(주) 회사(전자상거래 사업자)가 운영하는 누리보듬(주) 사이버 몰(이하 "몰"이라 한다)에서 
제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

* 「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준
용합니다」

제2조(정의)
①"몰" 이란 누리보듬(주) 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴
...
번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 누리보듬(주) 사이버몰의 초기 서비스화면(전면)
...
#카카오톡 알림톡 시행에 관한 내용
“SINABRO”은 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.
 

본 약관은 2011년12월29일부터 적용됩니다.
...
개인정보보호책임자 성명 : 김성연
전화번호　: 070-4353-1931~4
이메일　: trustseoul@gmail.com
...
#개인정보의 위탁 처리
“SINABRO”은 서비스 향상을 위해 관계법령에 따라 회원및 비회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원및 비회원의 개인정보를 외부에 위탁하여 처리하고 있습니다. “(쇼핑몰명)”의 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다.
 

 
본 방침은 : 2017년 06월 02일부터 시행됩니다.
</textarea>
</div>
